  ...
  return (
    <section className="main-section">
      ...
      <div className="text-section">
        ...
        <p>
        Você está pronto para explorar um mundo onde as fronteiras entre ecologia e tecnologia se desvanecem, dando origem a inovações impressionantes e soluções sustentáveis? Apresentamos a você o podcast que desvendará os segredos dessa convergência inspiradora - "DuoEcoTech".

        Embarque conosco em uma jornada auditiva que explora como as forças da natureza e o poder da tecnologia podem trabalhar em harmonia, transformando desafios globais em oportunidades empolgantes. A cada episódio, mergulhamos nas histórias de visionários que estão moldando o futuro, combinando seus conhecimentos em ecologia e tecnologia para criar soluções que reverberam além das fronteiras convencionais.
        ...
        Sintonize-se com "DuoEcoTech" e abrace o futuro onde a ecologia e a tecnologia se unem para moldar um mundo mais verde, mais inteligente e mais inspirador. O futuro está chamando - você está pronto para atender?
        </p>
      </div>
    </section>
  );

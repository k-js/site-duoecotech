...
const MainSection = () => {
  return (
    <section className="main-section">
      ...
      <img src={imgHome} alt="logo do vodcast" />
      </div>
      <div className="text-section">
        <h2>DuoEcoTech: Navegando a Confluência de Economia, Ecologia e Tecnologia</h2>
        <p>
        Você está pronto para explorar um mundo onde as fronteiras entre economia, ecologia e tecnologia se desvanecem, dando origem a inovações impressionantes e soluções sustentáveis? Apresentamos a você o vodcast que desvendará os segredos dessa convergência inspiradora - "DuoEcoTech".
        ...
        Desvendamos os segredos dos drones que monitoram os cantos mais remotos da Terra, da bioengenharia que se inspira na natureza para criar avanços incríveis e das cidades inteligentes que se adaptam às necessidades da natureza e das pessoas. Além disso, descobrimos como a tecnologia está revolucionando nossa compreensão da ecologia e economica, permitindo-nos tomar decisões informadas para um planeta mais saudável.

        "DuoEcoTech" não é apenas um vodcast - é uma jornada de descoberta, inspiração e ação. Junte-se a nós enquanto exploramos um futuro onde a ecologia e a tecnologia se entrelaçam de maneira harmoniosa e colaborativa. Está na hora de desvendar o potencial transformador da convergência entre esses dois mundos. Prepare-se para desafiar suas perspectivas, alimentar sua curiosidade e ser parte da mudança.
